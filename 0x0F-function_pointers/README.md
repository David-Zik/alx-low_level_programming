0x0. C - Function pointers Mandatory
...
3-main.c - performs simple opertions passed in as parameters.
...
3-get_op_func.c - selects the correct function from 3-op_function.s to perform the operation asked by the user.

Advanced

100-main_opcodes.c - prints the opcodes of its own main function up to a specified numberof bytes.
